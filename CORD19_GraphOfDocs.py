...
def graphofdocs(create, initialize, dirpath, window_size, 
    ...
    if initialize:
        ...
        #create_similarity_graph(database) # DO NOT UNCOMMENT THIS LINE.
...
if __name__ == '__main__': graphofdocs(False, False, 'data/CORD-19-research-challenge', 4, False, True, False, False)
